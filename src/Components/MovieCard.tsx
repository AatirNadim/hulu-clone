...
const MovieCard = (movie: any) => {
  ...
  <div className="inline-block m-2 md:m-3 cursor-pointer group">
      <img src = {IMAGE_BASE_URL + movie.movie.backdrop_path} alt = 'movie' 
        className="w-[230x] md:w-[340px] object-cover rounded-2xl group-hover:border-[5px]
          border-gray-400 p-2 transition-all duration-300 ease-in-out
        "
      />
